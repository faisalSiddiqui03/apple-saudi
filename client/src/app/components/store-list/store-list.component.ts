...
export class StoreListComponent extends StoreSelectionComponent implements OnInit {
    ...
    handleWidgetActionFetchAreaPredictionsFailed(data: any): any {}
    handleWidgetActionFetchPlaceDetailsFailed(data: any): any {}
    handleWidgetActionFetchAreaPredictionsSuccess(data: any): any {}
